...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    try {
        $stmt = $conn->prepare("SELECT * FROM contact_message WHERE id = :id");
    ...
    header("Location: messageList.php?status=error&msg=Invalid ID");
    exit();
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <div class="message-form">
            ...
            <form class="form-group" action="message_update_controller.php" method="post" name="my_form" onsubmit="return(vailidate())"> 
            <?php
                ...
                <div class="form-rows">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" name="first_name" id="first_name" value="<?php echo $user['f_name'];?>" placeholder="Please enter first name">
                    </div>
                    <div class="form-field">
                        <label for="last_name">Last Name</label>
                        <input type="text" name="last_name" id="last_name" value="<?php echo $user['l_name'];?>" placeholder="Please enter last name">
                ...
                <div class="form-rows">
                    <div class="form-field">
                        ...
                        <input type="email" name="email" id="email" value="<?php echo $user['email']?>" placeholder="Please enter first name">
                        <span class="error" id="email_error"></span>

                    </div>
                    <div class="form-field">
                        <label for="phone">Phone</label>
                        <input type="number" name="phone" id="phone" value="<?php echo $user['phone']?>" placeholder="Please enter last name">
                ...
                <div class="form-field message">
                    ...
                    <textarea name="message" id="message" rows="4" placeholder="Please enter query..">
                        <?php echo htmlspecialchars(json_decode($user['message'] ?? '')); ?>
                    </textarea>
